...
test-contracts-asm:
	...
	@pipx runpip eth-ape freeze | grep -q ape-solidity || pipx inject eth-ape ape-solidity
	@pipx runpip eth-ape freeze | grep -q ape-hardhat || pipx inject eth-ape ape-hardhat
