...
AUTONITY_CONTRACT_DIR = ./autonity/solidity/contracts
...
test-contracts:
	...
	@cd $(AUTONITY_CONTRACT_DIR)/test/autonity/ && rm -Rdf ./data && ./autonity-start.sh &
	...
	@cd $(AUTONITY_CONTRACT_DIR) && $(NPMBIN)/truffle test && cd -
