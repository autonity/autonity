...
func makechain() (bc *core.BlockChain, addrHashes, txHashes []common.Hash) {
	...
	bc, _ = core.NewBlockChain(db, nil, gspec.Config, ethash.NewFaker(), vm.Config{}, nil, &core.TxSenderCacher{}, nil, backends.NewInternalBackend(nil), log.Root())
...
func newFuzzer(input []byte) *fuzzer {
	return &fuzzer{
		...
		pool:      core.NewTxPool(core.DefaultTxPoolConfig, params.TestChainConfig, chain, &core.TxSenderCacher{}),
