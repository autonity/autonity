...
type Proof struct {
	...
	Rule     Rule
	Message  tendermint.Message   // the msg to be considered as suspicious or misbehaved one
	Evidence []tendermint.Message // the proofs of innocence or misbehaviour.
}
