...
const (
	...
	BaseFeeChangeDenominator = 88              // Bounds the amount the base fee can change between blocks.
	ElasticityMultiplier     = 2               // Bounds the maximum gas limit an EIP-1559 block may have.
	InitialBaseFee           = 200_000_000_000 // Initial base fee for EIP-1559 blocks.
