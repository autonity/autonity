...
type Validator struct {
	...
	Pop                      []byte // the proof of ownership generated by sub command: genOwnershipProof
	State                    *uint8
}
...
func (v *Validator) Validate() error {
	...
	err = crypto.AutonityPOPVerify(v.Pop, v.Treasury.Hex(), *v.NodeAddress, v.OracleAddress, v.ConsensusKey)
	if err != nil {
		return err
	}
