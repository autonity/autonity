...
go test -race -v ./swarm/pss -cpu 4 -run TestNetwork
  ...
  4   github.com/clearmatics/autonity/swarm/pss.(*Pss).forward.func1()
  5       /Users/nonsense/code/src/github.com/clearmatics/autonity/swarm/pss/pss.go:654 +0x44f
  6   github.com/clearmatics/autonity/swarm/network.(*Kademlia).eachConn.func1()
  7       /Users/nonsense/code/src/github.com/clearmatics/autonity/swarm/network/kademlia.go:350 +0xc9
  8   github.com/clearmatics/autonity/pot.(*Pot).eachNeighbour.func1()
  9       /Users/nonsense/code/src/github.com/clearmatics/autonity/pot/pot.go:599 +0x59
  ...

 28
 29 Previous write at 0x00c424d456a0 by goroutine 829:
 30   github.com/clearmatics/autonity/swarm/pss.(*Pss).Run()
 31       /Users/nonsense/code/src/github.com/clearmatics/autonity/swarm/pss/pss.go:192 +0x16a
 32   github.com/clearmatics/autonity/swarm/pss.(*Pss).Run-fm()
 33       /Users/nonsense/code/src/github.com/clearmatics/autonity/swarm/pss/pss.go:185 +0x63
 34   github.com/clearmatics/autonity/p2p.(*Peer).startProtocols.func1()
 35       /Users/nonsense/code/src/github.com/clearmatics/autonity/p2p/peer.go:347 +0x8b
 ...
```
