...
2. Update the `extra-data` property in the genesis file by encoding it with the [istanbul tools](https://github.com/getamis/istanbul-tools)
3. Update the `enodeWhitelist` property in the genesis file. Enode address can be a few formats:
