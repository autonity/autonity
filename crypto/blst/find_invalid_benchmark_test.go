...
func BenchmarkAggregateVerifyInvalid(b *testing.B) {
	...
	b.Run("50 uniformly distributed of 1000", func(b *testing.B) {
	...
	b.Run("100 uniformly distributed of 1000", func(b *testing.B) {
	...
	b.Run("50 random of 1000", func(b *testing.B) {
		...
		Loop:
			...
			failed[i] = index
			invalid = append(invalid, failed[i])
		}
		/*
			b.Run("simple", func(b *testing.B) {
				runBenchmarkAggregateVerifyInvalid(b, 1000, failed...)
	...
	b.Run("100 random of 1000", func(b *testing.B) {
	...
	b.Run("200 random of 1000", func(b *testing.B) {
	...
	b.Run("1/3 random of 1000", func(b *testing.B) {
