...
import (
	...
	"github.com/autonity/autonity/eth/tracers/internal"
	...
	jsassets "github.com/autonity/autonity/eth/tracers/js/internal/tracers"
)
...
func (t *jsTracer) OnTxStart(env *tracing.VMContext, tx *types.Transaction, from common.Address) {
	...
	rules := t.chainConfig.Rules(env.BlockNumber, env.Random != nil)
