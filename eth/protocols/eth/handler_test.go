...
// TODO: Receipt RLP encoding differs between network (817 bytes) and expected (8 bytes).
// This needs investigation of receipt storage/encoding in Autonity.
func TestGetBlockReceipts68(t *testing.T) {
	t.Skip("receipt RLP encoding mismatch needs investigation")
