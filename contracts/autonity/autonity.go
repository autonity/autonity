...
func (ac *Contract) GetProposerFromAC(block *types.Block, db *state.StateDB, height uint64, round int64) common.Address {
	return ac.callGetProposerFromAC(db, block.Header(), height, round)
}
