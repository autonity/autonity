...
func ExampleGenerateChain() {
	...
	chain, _ := GenerateChain(gspec.Config, genesis, ethash.NewFaker(), genDb, 5, func(i int, gen *BlockGen) {
		...
		case 1:
			...
			tx1, _ := types.SignTx(types.NewTransaction(gen.TxNonce(addr1), addr2, big.NewInt(21000000001000), params.TxGas, new(big.Int).SetUint64(params.TestMinBaseFee), nil), signer, key1)
