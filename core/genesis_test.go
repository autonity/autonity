		...
		*/
		...
		},
		{
			...
			fn: func(db ethdb.Database) (*params.ChainConfig, common.Hash, *params.ConfigCompatError, error) {
				...
				bc, _ := NewBlockChain(db, DefaultCacheConfigWithScheme(scheme), &oldcustomg, ethash.NewFullFaker(), vm.Config{}, nil, FakeContractBackendProvider(t), log.Root())
				defer bc.Stop()
...
func TestGenesisHashes(t *testing.T) {
	...
	/*
		for i, c := range []struct {
			...
			{DefaultPiccadillyGenesisBlock(), params.SepoliaGenesisHash},
...
func TestVerkleGenesisCommit(t *testing.T) {
	...
	// Autonity adds extra genesis state (Autonity contract, Oracle contract) which changes the state root
	expected := common.FromHex("0ed286bdc7cdd00be6f5890ade5925197f126a4642a28cd8df9b8868a120fbfa")
