...
func testRepair(t *testing.T, tt *rewindTest, snapshots bool) {
	...
	chain, err = NewBlockChain(db, nil, params.AllEthashProtocolChanges, engine, vm.Config{}, nil, new(TxSenderCacher), nil)
	if err != nil {
...
// TestIssue23496 tests scenario described in https://github.com/clearmatics/autonity/pull/23496#issuecomment-926393893
