...
func TestDAOForkRangeExtradata(t *testing.T) {
	...
	proConf := *params.TestConfigNoVerkle
	...
	conConf := *params.TestConfigNoVerkle
	...
	conBc, _ := NewBlockChain(conDb, nil, congspec, ethash.NewFaker(), vm.Config{}, nil, FakeContractBackendProvider(t), log.Root())
	defer conBc.Stop()
	...
	for i := int64(0); i < params.DAOForkExtraRange.Int64(); i++ {
		...
		bc, _ := NewBlockChain(rawdb.NewMemoryDatabase(), nil, congspec, ethash.NewFaker(), vm.Config{}, nil, FakeContractBackendProvider(t), log.Root())
		...
		bc, _ = NewBlockChain(rawdb.NewMemoryDatabase(), nil, progspec, ethash.NewFaker(), vm.Config{}, nil, FakeContractBackendProvider(t), log.Root())
