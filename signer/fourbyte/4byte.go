...
var __4byteJson = []byte(`{
  ...
  "39494a06": "ORACLE_REWARD_RATE_PRECISION()",
  "ed5676e9": "setOracleRewardRate(uint256)",
  "f0141d84": "getDecimals()",
  "631cbe3c": "receiveRewards()",
...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xb6, 0xc4, 0x1a, 0x94, 0x7c, 0xe5, 0xc, 0xa4, 0xb0, 0xc7, 0x3f, 0xa0, 0xf5, 0xa7, 0x83, 0xdf, 0x5, 0x41, 0x1e, 0xea, 0x94, 0xdc, 0xcf, 0xe8, 0x2a, 0xea, 0x8e, 0x3e, 0x59, 0x2c, 0x5b, 0x86}}
	return a, nil
}
