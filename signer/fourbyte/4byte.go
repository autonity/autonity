...
var __4byteJson = []byte(`{
  ...
  "07f62b2d": "getNewAddress()",
  "d70188cd": "getNewMapNum(uint256)",
  "f8e652d0": "getNewMapStruct(uint256)",
  "f0d3ce34": "getNewNum()",
  "133573cd": "getNewNumArray()",
  "fd10d2c2": "getNewStruct()",
  "5eb08b59": "getNewStructArray()",
  "71587988": "setNewAddress(address)",
  "44002530": "setNewMapNum(uint256,uint256)",
  "8d4d671e": "setNewMapStruct(uint256,(uint256,address))",
  "09316f5d": "setNewNum(uint256)",
  "51830a53": "setNewNumArray(uint256[])",
  "85c14ed8": "setNewStruct((uint256,address))",
  "292bec10": "setNewStructArray((uint256,address)[])"
}
`)
...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x41, 0xf1, 0x94, 0x9f, 0xd8, 0xaf, 0xe0, 0x52, 0xbe, 0x4e, 0x98, 0xb6, 0xf5, 0x4c, 0xaf, 0x4e, 0x23, 0xed, 0xa, 0xd7, 0xaf, 0xe5, 0x33, 0x94, 0x1a, 0x48, 0x42, 0x24, 0x79, 0x9f, 0x66, 0xf1}}
	return a, nil
}
