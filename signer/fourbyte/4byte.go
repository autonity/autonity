...
var __4byteJson = []byte(`{
  ...
  "67f0bcff": "finalize(bool,(address,uint256,bytes)[])",
...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xb6, 0xb2, 0x71, 0xd8, 0xaa, 0xeb, 0x64, 0x33, 0xcd, 0xe0, 0x3d, 0xd2, 0xa0, 0xc6, 0x59, 0x6c, 0xd4, 0xc8, 0xe, 0x9b, 0x56, 0xb2, 0x7c, 0xf1, 0x21, 0x91, 0x8a, 0x56, 0xbb, 0xd6, 0x83, 0xaf}}
	return a, nil
}
