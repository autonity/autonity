...
var __4byteJson = []byte(`{
  ...
  "17dc92c8": "vote(uint256,string[],(uint120,uint8)[],uint256,uint8)"
}
`)
...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x61, 0xf8, 0x69, 0xec, 0xcd, 0x24, 0xfe, 0xcf, 0xe7, 0x36, 0xc3, 0x5d, 0xd4, 0xf1, 0xdb, 0xea, 0xb, 0x4a, 0x2e, 0xd8, 0xae, 0x98, 0xc6, 0xf, 0x67, 0x21, 0xb, 0xe4, 0x17, 0xe8, 0x56, 0x81}}
	return a, nil
}
