...
var __4byteJson = []byte(`{
  ...
  "deae3481": "setNonRevealThreshold(uint256)",
  "3bd17b39": "setRevealResetInterval(uint256)"
}
`)
...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x47, 0x21, 0xbc, 0xfa, 0xf1, 0x4f, 0xb9, 0x89, 0x88, 0x7a, 0x36, 0x73, 0xf1, 0xdf, 0x48, 0x9d, 0xe2, 0x48, 0x3, 0x86, 0x85, 0x9f, 0x1b, 0x21, 0xe0, 0x43, 0x1b, 0xbe, 0x4, 0xb2, 0x25, 0x1c}}
	return a, nil
}
