...
var __4byteJson = []byte(`{
  ...
  "674c11b5": "getMissedRevealTolerance()",
  "c27a2e4c": "setMissedRevealTolerance(uint256)",
  "411e8a6f": "setNoRevealPenaltyResetRound(uint256)"
}
`)
...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x7a, 0x55, 0xd0, 0xdd, 0xeb, 0xc4, 0x9d, 0xe7, 0x91, 0x9e, 0xbe, 0x49, 0xe8, 0x77, 0xc7, 0xc4, 0x4f, 0x52, 0x1a, 0x29, 0x7b, 0xd0, 0x63, 0x81, 0x67, 0x5a, 0x27, 0x28, 0xa4, 0x70, 0x40, 0x9e}}
	return a, nil
}
