...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x7a, 0xcf, 0xeb, 0xb6, 0xb0, 0x61, 0x2a, 0xdb, 0x8f, 0xe8, 0x94, 0xf2, 0x63, 0xdb, 0xfb, 0xea, 0x8d, 0x6e, 0x51, 0x5e, 0x2d, 0x45, 0x47, 0xb, 0xdf, 0x40, 0x76, 0x86, 0xb7, 0xfe, 0x4, 0xd}}
	return a, nil
}
