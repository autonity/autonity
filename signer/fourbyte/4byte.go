...
var __4byteJson = []byte(`{
  ...
  "38ce8a3c": "clientConfig()",
  "73beedcc": "finalizeInitialization((uint256,uint256,uint256))"
}
`)
...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x21, 0xa0, 0x5c, 0xd6, 0xea, 0xb1, 0xee, 0xeb, 0xc8, 0x8b, 0xa0, 0x89, 0xef, 0xee, 0xde, 0x56, 0x39, 0x74, 0x0, 0x63, 0x6a, 0x27, 0x98, 0xf6, 0x5, 0x52, 0xed, 0x5e, 0x36, 0x82, 0x3a, 0xae}}
	return a, nil
}
