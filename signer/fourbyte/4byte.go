...
var __4byteJson = []byte(`{
  ...
  "9ba2fc50": "slash((address,address,address,string,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,address,uint256,uint256,uint256,uint256,uint256,bytes,uint8),uint256,uint256,uint8,uint8)",
  "b1344271": "slasher()",
  "e744bfa9": "slashAtRate((address,address,address,string,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,address,uint256,uint256,uint256,uint256,uint256,bytes,uint8),uint256,uint256,uint8,uint8)"
}
`)
...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x94, 0x48, 0xbd, 0xc4, 0x58, 0x5e, 0xc5, 0x39, 0x92, 0x75, 0x82, 0xc5, 0x8c, 0x51, 0xc0, 0x6e, 0xf, 0xd7, 0x2d, 0xcd, 0xe3, 0x67, 0x6f, 0xd4, 0x25, 0xc3, 0x60, 0xed, 0xdf, 0x22, 0xda, 0x79}}
	return a, nil
}
