...
var __4byteJson = []byte(`{
  ...
  "2d94ae3d": "getLiquidLogicContract(address)",
...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x50, 0x5c, 0x5d, 0xbb, 0x96, 0x1a, 0xc1, 0x62, 0x9f, 0x22, 0xfd, 0x3e, 0x91, 0x2d, 0x18, 0x1f, 0xee, 0x1d, 0x90, 0x8b, 0xe0, 0xd3, 0xeb, 0xb, 0xb7, 0xf1, 0xc7, 0x89, 0x7a, 0x7e, 0xda, 0xb4}}
	return a, nil
}
