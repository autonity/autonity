...
var __4byteJson = []byte(`{
  ...
  "9bd28074": "setLatencyContract(address)",
  "57de26a4": "read()",
  "d118daf2": "report(uint8[])",
  "403bda8c": "report(uint256,uint8[])",
  "0c52965f": "LATENCY_CONTRACT()"
}
`)
...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xa1, 0x8e, 0x92, 0xcc, 0x85, 0xfe, 0x41, 0x42, 0x30, 0x76, 0x60, 0xeb, 0x64, 0x4f, 0xb9, 0x1a, 0x3, 0x5b, 0x36, 0xf9, 0x80, 0x8a, 0x99, 0xdd, 0xa3, 0x9a, 0x85, 0xbd, 0xc, 0x43, 0x9f, 0x22}}
	return a, nil
}
