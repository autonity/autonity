...
var __4byteJson = []byte(`{
  ...
  "b1344271": "slasher()",
  "bb1449f2": "SLASHING_RATE_PRECISION()",
  ...
  "1861b6bf": "applyBonding(address,uint256,uint256,uint256)",
  "a8a72ff1": "applyUnbonding(address,uint256,uint256,uint256,uint256,uint256,uint256)",
  "45946334": "getStakingPool()",
  "a25a1532": "getValidatorCommissionRate(address)",
  "bec72807": "releaseUnbondingStake(address,uint256,uint256,uint256,uint256)",
  "71ed8ed7": "setStakingPoolContract(address)",
  "5623cf43": "updateWithRejectedBondingAmount(address,uint256)",
  "cc60ea0f": "updateWithReleasedStake(address,uint256)",
  "5ad9e449": "balanceInContract(address)",
  "50cd3a4a": "balanceInPool(address)",
  "5f282e95": "burnFromPool(address,uint256)",
  "dc7da702": "lockInPool(address,address,uint256)",
  "b633505c": "mintInPool(address,uint256)",
  "2b5871ab": "redistribute(uint256,uint256,uint256)",
  "305bee16": "transferFromPool(address,uint256)",
  "0e59c5fc": "applyBonding(uint256)",
  "70ebb612": "applyUnbonding(uint256)",
  "0ed16ff7": "bond(address,uint256,address,uint256,bool)",
  "9fd13097": "calculateLiquidBurning(address,address)",
  "da393c5c": "calculateLiquidMinted(address,address)",
  "248c983d": "calculateRejectedBonding(address,uint256)",
  "dc99c1f9": "calculateReleasedStake(address)",
  "94c9be93": "collectRewards(address[],address[])",
  "0d5e7e4d": "getBondingArrayLength()",
  "f5502f22": "getBondingRequest(uint256)",
  "50686e29": "getUnbondingArrayLength()",
  "30bcb81c": "getUnbondingRequest(uint256)",
  "e0f42cfe": "rejectedBonding()",
  "76e40a36": "releaseUnbondingStake(uint256)",
  "76f5e78a": "releasedStakes()",
  "2eb1e42a": "unbond(address,uint256,address,uint256,bool)",
  "26d5134b": "updateDelegatorPool(address)",
  "f857eb08": "updateDelegatorPool(address,address)",
  "286c2e4f": "finalizeInitialization((address,uint256,bytes)[])",
  "4c80f2c3": "redistribute(uint256,uint256)",
  "be5d2302": "finalizeInitialization(((address,uint256,bytes)[],uint256,uint256,uint256,uint256),address[])",
  "00c9d509": "calculateRewards(address,address)",
  "25609bee": "runLoop()",
  "a18c84fd": "runLoop1()",
  "1fd6a5dd": "updateDelegatorPool1(address,address)",
  "4b151d65": "unbondingEpoch()"
}
`)
...
func _4byteJson() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x55, 0x73, 0xac, 0x48, 0x8a, 0x4b, 0xae, 0x4a, 0x46, 0xa3, 0xa, 0x5a, 0xf3, 0x9, 0xdf, 0x35, 0x9b, 0xda, 0x38, 0x7a, 0xeb, 0x59, 0xb3, 0x37, 0x7c, 0x2b, 0xdd, 0x68, 0xd, 0xae, 0xf7, 0x20}}
	return a, nil
}
