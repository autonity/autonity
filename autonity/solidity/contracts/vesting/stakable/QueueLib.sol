...
library QueueLib {
    function _enqueue(StakingRequestQueue storage _queue, PendingStakingRequest memory _item) internal {
        _queue.array.push(_item);
    }

    function _dequeue(StakingRequestQueue storage _queue, uint256 _deleteCount) internal {
