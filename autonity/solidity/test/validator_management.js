...
contract('Autonity', function (accounts) {
    ...
    describe('Validator management', function () {
        ...
        it('Add validator with already registered address', async function () {
            ...
            await truffleAssert.fails(
                autonity.registerValidator(enode, genesisNodeAddresses[0], consensusKey, multisig, {from: newValidator}),
        ...
        it('Add a validator with invalid enode address', async function () {
            ...
            await truffleAssert.fails(
                autonity.registerValidator(enode, newValidator, consensusKey, multisig, {from: newValidator}),
                truffleAssert.ErrorType.REVERT,
                "enode error"
            );
        ...
        it('Add a validator with invalid oracle proof', async function () {
            ...
            await truffleAssert.fails(
                autonity.registerValidator(enode, oracleAddr, consensusKey, multisig, {from: newValidator}),
                truffleAssert.ErrorType.REVERT,
        ...
        it('Add a validator with valid meta data', async function () {
            ...
            await autonity.registerValidator(enode, oracleAddr, consensusKey, multisig, {from: issuerAccount});
            let vals = await autonity.getValidators();
        ...
        it('Pause a validator', async function () {
            ...
            await autonity.registerValidator(enode, oracleAddr, consensusKey, multisigs, {from: issuerAccount});
    ...
    describe('Test committee members rotation through bonding/unbonding', function () {
        ...
        let consensusKey1 = Buffer.from("a39f5fd136836a203bfd13d8acc631199c478d9aaa67b147989bdc75676c9e084c0e3396011ff370ca4635723c335a03", "hex");
        ...
        let consensusKey2 = Buffer.from("9271d72f26539bbb1beb011b63fa63c56a7c225e9e20933cc8a501204fdf8b302922e11e9d45015d6547dd4e117b9c5e", "hex");
        ...
        it('test bond stake token to new added validators, new validators should be elected as committee member', async function() {
            ...
            await token.registerValidator(enodeVal1, oracle1, consensusKey1, multisig1, {from: validator1});
            await token.registerValidator(enodeVal2, oracle2, consensusKey2, multisig2, {from: validator2});
