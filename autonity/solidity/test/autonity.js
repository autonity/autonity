...
contract('Autonity', function (accounts) {
  ...
  describe('Validator management', function () {
    ...
    it('Add a validator with invalid enode address', async function () {
      ...
      let activityKey = '0xb4c9a6216f9e39139b8ea2b36f277042bbf5e1198d8e01cff0cca816ce5cc820e219025d2fa399b133d3fc83920eeca5';
      ...
      await truffleAssert.fails(
        autonity.registerValidator(enode, newValidator, activityKey.substring(2), multisig, {from: newValidator}),
        truffleAssert.ErrorType.REVERT,
        "enode error"
      );
    ...
    it('Add a validator with invalid oracle proof', async function () {
      ...
      await truffleAssert.fails(
        autonity.registerValidator(enode, oracleAddr, activityKey.substring(2), multisig, {from: newValidator}),
        truffleAssert.ErrorType.REVERT,
    ...
    it('Add a validator with valid meta data', async function () {
      ...
      let activityKey = "0xb4c9a6216f9e39139b8ea2b36f277042bbf5e1198d8e01cff0cca816ce5cc820e219025d2fa399b133d3fc83920eeca5"
      let multisig = ""
      let oracleAddr = newValAddr

      await autonity.registerValidator(enode, oracleAddr, activityKey.substring(2), multisig.substring(2), {from: issuerAccount});
      let vals = await autonity.getValidators();
    ...
    it('Pause a validator', async function () {
      ...
      let enode = freeEnodes[0]
      let activityKey = "0xb4c9a6216f9e39139b8ea2b36f277042bbf5e1198d8e01cff0cca816ce5cc820e219025d2fa399b133d3fc83920eeca5"
      let multisigs = ""
      ...
      await autonity.registerValidator(enode, oracleAddr, activityKey.substring(2), multisigs.substring(2), {from: issuerAccount});
  ...
  describe('Test committee members rotation through bonding/unbonding', function () {
    let activityKey1 = "0xa39f5fd136836a203bfd13d8acc631199c478d9aaa67b147989bdc75676c9e084c0e3396011ff370ca4635723c335a03"
    let multisig1 = ""
    let activityKey2 = "0x9271d72f26539bbb1beb011b63fa63c56a7c225e9e20933cc8a501204fdf8b302922e11e9d45015d6547dd4e117b9c5e"
    let multisig2 = ""
      let vals = [
        { ...baseValidator,
          "treasury": accounts[0],
          "nodeAddress": genesisNodeAddresses[0],
      ...
      it('test bond stake token to new added validators, new validators should be elected as committee member', async function() {
          ...
          await token.registerValidator(enodeVal1, oracle1, activityKey1.substring(2), multisig1.substring(2), {from: validator1});
          await token.registerValidator(enodeVal2, oracle2, activityKey2.substring(2), multisig2.substring(2), {from: validator2});
