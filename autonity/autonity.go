...
func (c *AutonityContract) CommitteeEnodes(block *types.Block, db *state.StateDB, asATC bool) (*types.Nodes, error) {
	return c.callGetCommitteeEnodes(db, block.Header(), asATC)
}
