...
- 2021-08-24: Released [v1.10.8](https://github.com/autonity/autonity/releases/tag/v1.10.8) containing the fix on
...
- Place the fix into the PR optimizing the jumpdest
  analysis [233381](https://github.com/autonity/autonity/pull/23381).
...
It was also found that the same attack had been carried out on the BSC chain at roughly the same time -- at a block
