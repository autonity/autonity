...
func doTest(cmdline []string) {
	...
	gotest.Args = append(gotest.Args, "-p", "1", "-timeout", "30m")
	if *coverage {
...
func doLint(cmdline []string) {
	...
	// Run fast linters batched toautonityer
	configs := []string{
		"--vendor",
		"--tests",
		"--deadline=2m",
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/clearmatics/autonity/mobile")
