...
// public writers
func (t *transactor) registerValidator(enode string, oracleAddress common.Address, multisig []byte) (*types.Transaction, error) {
	return t.execute(func(instance *Autonity, opts *bind.TransactOpts) (*types.Transaction, error) {
		return instance.RegisterValidator(opts, enode, oracleAddress, multisig)
	})
}
...
func (c *caller) getCommittee() ([]AutonityCommitteeMember, error) {
	var committee []AutonityCommitteeMember
	err := c.execute(func(instance *Autonity, opts *bind.CallOpts) error {
...
func (c *caller) getBondingReq(startId *big.Int, lastId *big.Int) ([]AutonityStaking, error) {
	var reqs []AutonityStaking
	err := c.execute(func(instance *Autonity, opts *bind.CallOpts) error {
...
func (c *caller) getUnBondingReq(startId *big.Int, lastId *big.Int) ([]AutonityStaking, error) {
	var reqs []AutonityStaking
	err := c.execute(func(instance *Autonity, opts *bind.CallOpts) error {
