...
var (
	ProposalWriteBg  = metrics.NewRegisteredBufferedGauge("acn/proposal/write", nil, getIntPointer(1000))  // time to write proposal to wire
	PrevoteWriteBg   = metrics.NewRegisteredBufferedGauge("acn/prevote/write", nil, getIntPointer(5000))   // time to write prevote to wire
	PrecommitWriteBg = metrics.NewRegisteredBufferedGauge("acn/precommit/write", nil, getIntPointer(5000)) // time to write precommit to wire
