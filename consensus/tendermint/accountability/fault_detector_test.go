...
func TestPrevotesAccountabilityCheck(t *testing.T) {
	...
	aggregatedPrevoteForB := message.AggregatePrevotes([]message.Vote{prevoteForB, otherPrevoteForB}, common.Address{})
	aggregatedPrevoteForB1 := message.AggregatePrevotes([]message.Vote{prevoteForB1, otherPrevoteForB1}, common.Address{})
	...
	otherPrecommitForB := newValidatedPrecommit(precommitForB.R(), precommitForB.H(), precommitForB.Value(),
		makeSigner(keys[prevoterIdx]), &committee.Members[prevoterIdx], cSize)
	aggregatedPrecommitForB := message.AggregatePrecommits([]message.Vote{precommitForB, otherPrecommitForB}, common.Address{})
	...
	otherPrecommitForB1 := newValidatedPrecommit(precommitForB1.R(), precommitForB1.H(), precommitForB1.Hash(),
		makeSigner(keys[prevoterIdx]), &committee.Members[prevoterIdx], cSize)
	aggregatedPrecommitForB1 := message.AggregatePrecommits([]message.Vote{precommitForB1, otherPrecommitForB1}, common.Address{})
	...
	otherPrevoteForOldB10 := newValidatedPrevote(prevoteForOldB10.R(), prevoteForOldB10.H(), prevoteForOldB10.Value(),
		makeSigner(keys[prevoterIdx]), &committee.Members[prevoterIdx], cSize)
	aggregatedPrevoteForOldB10 := message.AggregatePrevotes([]message.Vote{prevoteForOldB10, otherPrevoteForOldB10}, common.Address{})
	...
	aggregatedPrecommitForB1In8 := message.AggregatePrecommits([]message.Vote{precommitForB1In8, otherPrecommitForB1In8}, common.Address{})
	...
	t.Run("misbehaviour when pi prevotes for an old proposal while in the valid round there is quorum for different value", func(t *testing.T) {
		...
		aggVr5Votes := message.AggregatePrevotes(vr5Prevotes, common.Address{})
...
func TestPrecommitsAccountabilityCheck(t *testing.T) {
	...
	t.Run("multiple proofs can be returned from precommits accountability check", func(t *testing.T) {
		...
		aggVoteForB1 := message.AggregatePrevotes(votesForB1, common.Address{})
...
func aggregatedPreVote(numOfSigners int, h uint64, r int64, v common.Hash, keys []blst.SecretKey,
	...
	aggregatedVote := message.AggregatePrevotes(votes, common.Address{})
