...
func (m *MockChainContext) MinBaseFeeByNumber(number uint64) (*big.Int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockChainContextMockRecorder) MinBaseFeeByNumber(number any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MinBaseFeeByNumber", reflect.TypeOf((*MockChainContext)(nil).MinBaseFeeByNumber), number)
}
