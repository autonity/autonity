...
// Package mock_accountability is a generated GoMock package.
...
func (mr *MockChainContextMockRecorder) GetBlock(hash, number interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainContextMockRecorder) GetHeader(hash, number interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainContextMockRecorder) GetHeaderByHash(hash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainContextMockRecorder) GetHeaderByNumber(number interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainContextMockRecorder) GetTd(hash, number interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainContextMockRecorder) HasBadBlock(hash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockChainContext) ProtocolContracts() *autonity.Contracts {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProtocolContracts")
	ret0, _ := ret[0].(*autonity.Contracts)
	return ret0
}
...
func (mr *MockChainContextMockRecorder) StateAt(root interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChainContextMockRecorder) SubscribeChainEvent(ch interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
