...
//
//	mockgen -source=consensus/tendermint/router/interfaces/interfaces.go -package=interfaces -destination=consensus/tendermint/router/mocks/interfaces_mock.go
//
