...
// IsProposerForRound mocks base method
func (m *MockSet) IsProposerForRound(lastCommittedBlockProposer common.Address, round uint64, address common.Address) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsProposerForRound", lastCommittedBlockProposer, round, address)
	ret0, _ := ret[0].(bool)
	return ret0
}

// IsProposerForRound indicates an expected call of IsProposerForRound
func (mr *MockSetMockRecorder) IsProposerForRound(lastCommittedBlockProposer, round, address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsProposerForRound", reflect.TypeOf((*MockSet)(nil).IsProposerForRound), lastCommittedBlockProposer, round, address)
}
