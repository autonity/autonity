...
func (m *MockGossiper) Gossip(committee *types.Committee, arg1 message.Msg, isLocal bool) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Gossip", committee, arg1, isLocal)
}

// Gossip indicates an expected call of Gossip.
func (mr *MockGossiperMockRecorder) Gossip(committee, arg1, isLocal any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Gossip", reflect.TypeOf((*MockGossiper)(nil).Gossip), committee, arg1, isLocal)
}
...
func (m *MockGossiper) SlowGossip(committee *types.Committee, arg1 message.Msg, isLocal bool) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SlowGossip", committee, arg1, isLocal)
}

// SlowGossip indicates an expected call of SlowGossip.
func (mr *MockGossiperMockRecorder) SlowGossip(committee, arg1, isLocal any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SlowGossip", reflect.TypeOf((*MockGossiper)(nil).SlowGossip), committee, arg1, isLocal)
}
