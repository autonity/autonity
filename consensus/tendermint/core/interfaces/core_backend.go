...
type Backend interface {
	...
	Broadcast(ctx context.Context, committee types.Committee, code uint64, payload []byte) error
	...
	Gossip(ctx context.Context, committee types.Committee, code uint64, payload []byte)
