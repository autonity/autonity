...
func (c *core) handlePreprepare(msg *message, src tendermint.Validator) error {
	logger := c.logger.New("from", src, "state", c.state)

	// Decode PRE-PREPARE
	var preprepare *tendermint.Preprepare
...
func (c *core) acceptPreprepare(preprepare *tendermint.Preprepare) {
