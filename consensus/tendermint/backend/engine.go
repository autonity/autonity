...
func (sb *Backend) verifyHeader(chain consensus.ChainReader, header, parent *types.Header) error {
	...
	return sb.verifyHeaderAgainstParent(chain, header, parent)
}

// verifyHeaderAgainstParent verifies that the given header is valid with respect to its parent.
func (sb *Backend) verifyHeaderAgainstParent(chain consensus.ChainReader, header, parent *types.Header) error {
...
func (sb *Backend) verifyCommittedSeals(chain consensus.ChainReader, header, parent *types.Header) error {
	...
	// Check whether the committed seals were generated by committee defined in parent.
