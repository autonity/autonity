...
func init() {
	...
	ethashChainConfig.AutonityContractConfig.Prepare(ethashChainConfig.OmissionAccountabilityConfig.LookbackWindow, ethashChainConfig.OmissionAccountabilityConfig.Delta)
	...
	tendermintChainConfig.AutonityContractConfig.Prepare(tendermintChainConfig.OmissionAccountabilityConfig.LookbackWindow, ethashChainConfig.OmissionAccountabilityConfig.Delta)
