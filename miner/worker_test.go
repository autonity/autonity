...
func init() {
	...
	ethashChainConfig.AutonityContractConfig.Prepare(ethashChainConfig.OmissionAccountabilityConfig.LookbackWindow)
	...
	tendermintChainConfig.AutonityContractConfig.Prepare(tendermintChainConfig.OmissionAccountabilityConfig.LookbackWindow)
